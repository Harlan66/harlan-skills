---
name: harlan-x-article-publisher
description: |
...
python <skill-path>/scripts/table_to_image.py /tmp/table.md /tmp/table.png
...
```bash
python <skill-path>/scripts/parse_markdown.py /path/to/article.md
```
...
python <skill-path>/scripts/copy_to_clipboard.py html --file /tmp/article_html.html
```
...
python <skill-path>/scripts/copy_to_clipboard.py image /path/to/img.jpg --quality 85
```
...
python <skill-path>/scripts/parse_markdown.py /path/to/article.md > /tmp/article.json
python <skill-path>/scripts/parse_markdown.py /path/to/article.md --html-only > /tmp/article_html.html
```
